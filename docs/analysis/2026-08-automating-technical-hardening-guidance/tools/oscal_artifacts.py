...
#  site root. tools/profile_first_corpus.py writes it from the guidance under
#  sources/, and the inventory counts it like any other while the note says
#  whose it is.
SITE_CORPORA = {"profile-first": os.path.join("examples", "profile-first", "oscal")}
...
UNPUBLISHED = {
    "profile-first": {
        "note": ("No proponent has published OSCAL for this approach. What "
                 ...
                 "listed here were generated by tools/profile_first_corpus.py "
...
LINK_BASE = {
    ...
    "profile-first": "examples/profile-first/oscal/",
}
