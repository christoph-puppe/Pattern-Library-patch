...
def scan(rel_root, under=None):
    #  A corpus held in this repository, under the site root, is scanned by
    #  path; a locked source input is resolved through the source lock and
    #  has to be present.
    if under:
        base = os.path.join(under, rel_root)
    else:
